...
const Code = () => {
  ...
  return (
    ...
    <div className='grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 bg-zinc-200 dark:bg-zinc-950 dark:text-white h-full pt-20' >
        {data.map ((items, i) => (
            <div key={items.id} className='bg-neutral-100 rounded-lg m-3 w-50 dark:bg-blue-950 dark:text-white group hover:shadow-lg' onClick={() => openInNewTab(items.link)}>
