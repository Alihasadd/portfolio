  ...
  return (
    <div className='grid grid-cols-1 bg-zinc-200 dark:bg-blue-900 dark:text-white pt-20'>
      ...
      <div className='bg-neutral-100 rounded-lg mr-10 ml-10 w-50 dark:bg-blue-950 dark:text-white group hover:shadow-lg p-10'>
        ...
        <p className='pb-3'>I started my career as a recruiter in JP Morgan Chase and then CIBC (Canadian Imperial Bank of Commerce). I wanted to help build a team so I decided to go to a startup next. I joined an Ad-tech company in New York where I helped build out there recruiting and people operations practices.</p>
        <p className='pb-3'>It was at that I started to work with a tech team who planted the seed to learn more about coding and software engineering. I decided to do a part time course at General Assembly to learn more. I loved the class but couldn't apply it easily. I kept up learning small bits here and there. </p>
