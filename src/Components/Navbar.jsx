    ...
    <div className="fixed w-full ">
      ...
      <div className='flex items-center gap-2 '>
        ...
        <ul className='flex flex-row gap-2 '>
          ...
          <li className='p-2 rounded-lg  hover:shadow-md hover:bg-pink-800 dark:bg-blue dark text-slate-200 dark:text-white'>
            <a href="/code">Code</a>
          </li>
          <li className='p-2 rounded-lg  hover:shadow-md hover:bg-pink-800 dark:bg-purple dark text-slate-200 dark:text-white'>
        ...
        <div className='flex items-center gap-2 m-2'>
            <button className=' w-10 h-10 rounded-full  dark:bg-pink-950 text-white hover:shadow-md' onClick={toggleDarkMode}>{darkMode ?  <img src={lighticon}/> : <img src={darkicon}/>}</button>
        <ul className='flex flex-row gap-2'>
          
          <li className='p-2  hover:bg-indigo-200 hover:shadow-md text-white dark:bg-rose-950 dark rounded-full '>
